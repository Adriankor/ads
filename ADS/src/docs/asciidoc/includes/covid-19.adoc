IMPORTANT: Auf Grund von COVID-19 wird es in diesem Semester *keine Klausur geben, dementsprechend gibt es keine Zusatzpunkte zur Klausur*. Als Alternative müssen Sie *vier
